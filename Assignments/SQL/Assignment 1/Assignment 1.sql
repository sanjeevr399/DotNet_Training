...
create table Clients(
  ...
  insert into Clients (ClientId, Cname, Address, Email, Phone, Bussiness) values
(1001, 'ACME Utilities', 'noida', 'contact@acmeutil.com', '9567880032', 'Manufacturing'),
(1002, 'Trackon Consultants', 'Mumbai', 'consult@trackon.com', '8734210090', 'Consultant'),
(1003, 'MoneySaver Distributor', 'Kolkata', 'save@moneysaver.com', '7799886655', 'Reseller'),
(1004, 'Lawful Corp', 'Chennai', 'justice@lawful.com', '9210342219', 'Professional');

--CREATING DEPARTMENT TABLE
create table Departments( Deptno numeric(2) primary key,Dname varchar(15) not null,Loc varchar(20));

--INSERTING THE DATA IN THE DEPARTMENT TABLE
...
insert into Projects (Project_ID, Descr, Start_Date, Planned_End_Date, Actual_End_date, Budget, ClientId) values
...
--TO SEE HOW MANY TABLES IN OUR DATABASE
SELECT name
FROM sys.tables;